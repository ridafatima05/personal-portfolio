        ...
        <div className="grid grid-cols-1 lg:grid-cols gap-12">
          <div className="text-lg">
            <p>
              ...
              engaging, user-friendly websites and applications that deliver
              exceptional experiences. My skills span from designing intuitive
              interfaces to implementing responsive, dynamic front-end solutions
              ...
              and opportunities to expand my skill set and collaborate with
              like-minded individuals.
            </p>
            <p className="mt-6">
              I am always open to learning new technologies and improving my
              skills. I love working on innovative projects and collaborating
